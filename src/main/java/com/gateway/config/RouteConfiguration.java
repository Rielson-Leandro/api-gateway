...
import com.gateway.filter.RateLimitByIpGatewayFilter;
...
public class RouteConfiguration {
	...
	/*O método que vamo utilizar é baseado no caminho da solicitação, da seguinte forma
	 * foi definido uma rota no propeties chamada service_to_web que encaminha o coaminho da
	 * solicitação para a instância de serviço authdemo com /demo/** solicitações. 
	 * 
	 *  Na definição de roteamento, foi configurado os parametros host, cabeçalho de solicitação 
	 *  e solicitação.
	 *  */
